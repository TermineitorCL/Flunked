                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="login_general.jsp" class="active">Login</a></li>
                    ...
                    <div class="row contact-wrap"> 
                        <div class="form-group">
                            <div class="col-12 col-sm-8 col-md-6 ">
                                <a href="login_cliente.jsp" class="btn btn-primary btn-lg">Login de Cliente</a>
                            </div>
                            <div class="col-12 col-sm-8 col-md-6">
                                <a href="login_intermediario.jsp" class="btn btn-primary btn-lg">Login de Intermediario</a>
                            </div>
                        </div>                   
                    </div>
                </div>
